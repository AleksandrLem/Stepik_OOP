# С помощью множественного наследования постройте иерархию
# из приведенных ниже четырех классов. При решении старайтесь
# свести дублирование кода к минимуму.

# 1. Реализуйте класс Father, описывающий отца. При создании
...
# be_strict() — метод, изменяющий значение атрибута
# mood на строку strict
# 2. Также реализуйте класс Mother, описывающий мать. При
...
# be_kind() — метод, изменяющий значение атрибута
# mood на строку kind
